...
struct Vector2 {
    ...
    [[nodiscard]] Vector2 with(const std::optional<float> &newX = std::nullopt, const std::optional<float> &newY = std::nullopt) const {
    ...
    [[nodiscard]] Vector2 add(const std::optional<float> &toX = std::nullopt, const std::optional<float> &toY = std::nullopt) const {
...
struct Vector3 {
    ...
    // 'with' and 'add' functions
    [[nodiscard]] Vector3 with(const std::optional<float> &newX = std::nullopt, const std::optional<float> &newY = std::nullopt, const std::optional<float> &newZ = std::nullopt) const {
    ...
    [[nodiscard]] Vector3 add(const std::optional<float> &toX = std::nullopt, const std::optional<float> &toY = std::nullopt, const std::optional<float> &toZ = std::nullopt) const {
